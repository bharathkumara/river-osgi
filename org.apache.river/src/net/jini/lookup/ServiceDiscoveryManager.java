...
public class ServiceDiscoveryManager {
    ...
    private static final class LookupCacheImpl implements LookupCache {
        ...
        public LookupCacheImpl(
                ...
                long leaseDuration,
                ServiceDiscoveryManager sdm,ClassLoader contextLoader) throws RemoteException {
            ...
            try {
                Exporter defaultExporter
                        = new BasicJeriExporter(TcpServerEndpoint.getInstance(0),
                                new BasicILFactory(null,null,contextLoader),
                                false, false);
    ...
    public ServiceItem lookup(ServiceTemplate tmpl,
        ...
        try {
            ...
            synchronized (cacheListener) {
                cache = createLookupCache(tmpl, filter, cacheListener, waitDur,classLoader);
                long duration = cache.getLeaseDuration();
                while (duration > 0) {
    ...
    public LookupCache createLookupCache(ServiceTemplate tmpl,
        ...
        return createLookupCache(tmpl, filter, listener, Long.MAX_VALUE,contextClassLoader);
    ...
    public LookupCache createLookupCache(ServiceTemplate tmpl,
            ServiceItemFilter filter,
            ServiceDiscoveryListener listener,ClassLoader contextLoader)
            throws RemoteException {
        checkTerminated();
        return createLookupCache(tmpl, filter, listener, Long.MAX_VALUE,contextLoader);
    }//end createLookupCache
                                                       ...
                                                       RemoteException
    {
        ...
        synchronized (cacheListener) { // uncontended lock.
            ...
            cache = createLookupCache(tmpl, filter, cacheListener, waitDur,contextClassLoader);
            long duration = cache.getLeaseDuration();
    ...
    private LookupCacheImpl createLookupCache(ServiceTemplate tmpl,
            ServiceItemFilter filter,
            ServiceDiscoveryListener listener,
            long leaseDuration,ClassLoader contextLoader)
            throws RemoteException {
        ...
        LookupCacheImpl cache = new LookupCacheImpl(tmpl, filter, listener, leaseDuration, this,contextLoader);
        cache.initCache();
        synchronized (caches) {
            caches.add(cache);
        }
