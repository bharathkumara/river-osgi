...
public class ServiceDiscoveryManager {
    ...
    public ServiceItem lookup(ServiceTemplate tmpl,
        ...
        try {
            ...
            synchronized (cacheListener) {
                cache = createLookupCache(tmpl, filter, cacheListener, waitDur,bundleLoader);
    ...
    public LookupCache createLookupCache(ServiceTemplate tmpl,
            ServiceItemFilter filter,
            ServiceDiscoveryListener listener,ClassLoader bundleLoader)
            throws RemoteException {
        checkTerminated();
        return createLookupCache(tmpl, filter, listener, Long.MAX_VALUE,bundleLoader);
    ...
    private LookupCacheImpl createLookupCache(ServiceTemplate tmpl,
            ...
            long leaseDuration,ClassLoader bundleLoader)
            throws RemoteException {
        ...
        LookupCacheImpl cache = new LookupCacheImpl(tmpl, filter, listener, leaseDuration, this, useInsecureLookup(),bundleLoader);
        cache.initCache();
        cachesWrite.lock();
        try {
            caches.add(cache);
