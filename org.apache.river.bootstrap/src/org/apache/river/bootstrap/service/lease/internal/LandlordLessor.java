 ...
 */
package org.apache.river.bootstrap.service.lease.internal;
 ...
 * configuration entry name is associated with the component name
 * <span *="" style="font-family: monospace;">org.rioproject.resources.
 * servicecore</span> <br>
 * </p>
 * <ul>
 * <li><span style="font-weight: bold;">landlordExporter </span>
 * <table cellpadding="2" *="" cellspacing="2" border="0" style="text-align:
 * left; width: 100%;">
 * <tbody>
 * <tr>
 * <td style="vertical-align: top; text-align: right; font-weight: bold;">Type:
 * </td>
 ...
 * {@link net.jini.jeri.BasicJeriExporter} with
 * <ul>
 ...
 * <td style="vertical-align: top; text-align: right; font-weight: bold;">
 * Description:</td>
 * <td style="vertical-align: top;">Specifies the Exporter to use to export this
 * service. This entry is obtained at service start and restart.</td>
 * </tr>
 * </tbody>
 * </table>
 * </li>
 ...
 *
 * <ul>
 * <li><span style="font-weight: bold;">reapingInterval</span>
 * <table cellpadding="2" *="" cellspacing="2" border="0" style="text-align:
 * left; width: 100%;">
 * <tbody>
 * <tr>
 ...
 * <td style="vertical-align: top; text-align: right; font-weight: bold;">
 * Default:</td>
 * <td style="vertical-align: top;">10 seconds <br>
 * </td>
 * </tr>
 * <tr>
 * <td style="vertical-align: top; text-align: right; font-weight: bold;">
 * Description:</td>
 * <td style="vertical-align: top;">The amount of time (in milliseconds) to
 * check for expired leases. Must be a positive long value.</td>
 * </tr>
 * </tbody>
 * </table>
 * </li>
 ...
 * *
 * <ul>
 * <li><span style="font-weight: bold;">landlordLeasePeriodPolicy </span>
 * <table cellpadding="2" *="" cellspacing="2" border="0" style="text-align:
 * left; width: 100%;">
 * <tbody>
 * <tr>
 ...
 * {@link com.sun.jini.landlord.LeasePeriodPolicy}</td>
 * </tr>
 * <tr>
 * <td style="vertical-align: top; text-align: right; font-weight: bold;">
 * Default:</td>
 * <td style="vertical-align: top;">A new
 * {@link com.sun.jini.landlord.FixedLeasePeriodPolicy} that allows leases up to
 * one day, and grants one hour leases for duration requests of
 * {@link net.jini.core.lease.Lease#ANY}</code> <br>
 * </td>
 * </tr>
 * <tr>
 * <td style="vertical-align: top; text-align: right; font-weight: bold;">
 ...
 * @author Dennis Reedy
 */
public class LandlordLessor extends ResourceLessor implements Landlord, ReferentUuid, ServerProxyTrust {
	/** The default time for a Lease: 1 hour */
	public static final long DEFAULT_LEASE_TIME = 60 * 1000 * 60 * 60;
	/** The maximum time for a Lease: 1 day */
	public static final long DEFAULT_MAX_LEASE_TIME = DEFAULT_LEASE_TIME * 24;
	 ...
	 * 
	 * @param config
	 *            The Configuration object used to initialize operational
	 *            values.
	 *
	 * @throws RemoteException
	 *             if errors occur setting up infrastructure
	 */
	 ...
	 *            values.
	 * @param leasePolicy
	 *            A LeasePeriodPolicy object to be used for the LandlordLessor.
	 *
	 * @throws RemoteException
	 *             if errors occur setting up infrastructure
	 */
	public LandlordLessor(final Configuration config, final LeasePeriodPolicy leasePolicy) throws RemoteException {
		...
		final LeasePeriodPolicy defaultLeasePeriodPolicy = (leasePolicy == null
				? new FixedLeasePeriodPolicy(DEFAULT_MAX_LEASE_TIME, DEFAULT_LEASE_TIME) : leasePolicy);

		try {
			this.leasePolicy = (LeasePeriodPolicy) Config.getNonNullEntry(config, COMPONENT,
					"landlordLeasePeriodPolicy", LeasePeriodPolicy.class, defaultLeasePeriodPolicy);
		} catch (ConfigurationException e) {
			logger.warn("Getting LeasePeriodPolicy in LandlordLessor", e);
		}

		try {
			final long reapingInterval = Config.getLongEntry(config, COMPONENT, "reapingInterval", 1000 * 60 * 10, 1,
					Long.MAX_VALUE);
		...
		exporter = exporter = new BasicJeriExporter(TcpServerEndpoint.getInstance(0),
				new BasicILFactory(null, null, getClass().getClassLoader()), false, true);
	 ...
	 * 
	 * @param force
	 *            if true, unexports the LandlordLessor even if there are
	 *            pending or in-progress calls; if false, only unexports the
	 *            LandlordLessor if there are no pending or in-progress calls
	 *
	 ...
	 * 
	 * @param cookie
	 *            Associated with the lease when it was created
	 * @param extension
	 *            The duration argument passed to the <code>Lease.renew()</code>
	 *            call
	 ...
	 * 
	 * @param cookie
	 *            Associated with each lease when it was created <br>
	 * @param extension
	 ...
	 * 
	 * @param cookies
	 *            Associated with the lease when it was created <br>
	 */
